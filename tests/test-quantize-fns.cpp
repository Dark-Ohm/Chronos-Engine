...
constexpr float MAX_QUANTIZATION_TOTAL_ERROR_TURBO2 = 0.0500f;
constexpr float MAX_QUANTIZATION_TOTAL_ERROR_TURBO3 = 0.0600f;
constexpr float MAX_QUANTIZATION_TOTAL_ERROR_TURBO4 = 0.0030f;
constexpr float MAX_QUANTIZATION_TOTAL_ERROR_Q2_1  = 0.006f;
constexpr float MAX_QUANTIZATION_TOTAL_ERROR_Q3_0  = 0.003f;
constexpr float MAX_QUANTIZATION_TOTAL_ERROR_Q3_1  = 0.003f;
    ...
    for (int i = 0; i < GGML_TYPE_COUNT; i++) {
        ...
        if (qfns_cpu->from_float && qfns->to_float) {
            ...
            const float max_quantization_error =
                ...
                type == GGML_TYPE_TURBO2_0 ? MAX_QUANTIZATION_TOTAL_ERROR_TURBO2 :
                type == GGML_TYPE_TURBO3_0 ? MAX_QUANTIZATION_TOTAL_ERROR_TURBO3 :
                type == GGML_TYPE_TURBO4_0 ? MAX_QUANTIZATION_TOTAL_ERROR_TURBO4 :
                type == GGML_TYPE_Q2_1    ? MAX_QUANTIZATION_TOTAL_ERROR_Q2_1 :
                type == GGML_TYPE_Q3_0    ? MAX_QUANTIZATION_TOTAL_ERROR_Q3_0 :
                type == GGML_TYPE_Q3_1    ? MAX_QUANTIZATION_TOTAL_ERROR_Q3_1 :
            ...
            if (qfns_cpu->vec_dot) {
                ...
                const float max_allowed_error = type == GGML_TYPE_Q2_K || type == GGML_TYPE_IQ2_XS || type == GGML_TYPE_IQ2_XXS ||
                    ...
                    type == GGML_TYPE_TQ3_1S || type == GGML_TYPE_Q3_0
                    ? MAX_DOT_PRODUCT_ERROR_LOWBIT
                    : type == GGML_TYPE_Q1_0
                    ? MAX_DOT_PRODUCT_ERROR_BINARY
                    : type == GGML_TYPE_TQ1_0 || type == GGML_TYPE_TQ2_0 || type == GGML_TYPE_Q2_0 || type == GGML_TYPE_Q2_1
