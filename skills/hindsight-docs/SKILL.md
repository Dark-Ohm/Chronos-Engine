...
- Review integration setups (Zed, Claude, MCP, and others)
...
│   └── memory-defense/ # Memory defense and safety
└── sdks/             # Python, Node.js, CLI, embedded
    └── integrations/ # LiteLLM, AI SDK, MCP, skills, and per-tool setups
```
...
# Integration changelogs (Zed, Claude, MCP, etc.)
references/changelog/integrations/*.md
...
references/developer/api/recall.md
```
...
Auto-generated reference snapshot from the upstream `hindsight-docs/docs/` source.
